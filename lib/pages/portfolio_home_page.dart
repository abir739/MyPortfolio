...
class _PortfolioHomePageState extends State<PortfolioHomePage>
  ...
  Color get _cardColor =>
      isDarkMode ? const Color(0xFF1E1A3A) : Colors.white;
  ...
  SliverAppBar _buildAppBar() {
    return SliverAppBar(
      ...
      actions: [
        IconButton(
          icon: Icon(isFrench ? Icons.language : Icons.translate,
              color: Colors.white),
      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            _buildDrawerItem(
                Icons.home, isFrench ? 'Accueil' : 'Home', 0),
            _buildDrawerItem(Icons.person,
                isFrench ? 'À Propos' : 'About', 700),
            _buildDrawerItem(Icons.work,
                isFrench ? 'Expérience' : 'Experience', 1400),
            _buildDrawerItem(
                Icons.apps, isFrench ? 'Projets' : 'Projects', 2800),
            _buildDrawerItem(Icons.star,
                isFrench ? 'Compétences' : 'Skills', 4200),
            _buildDrawerItem(Icons.school,
                isFrench ? 'Formation' : 'Education', 4900),
            _buildDrawerItem(
                Icons.contact_mail, 'Contact', 5500),
            const Divider(height: 32),
            ListTile(
              leading: Icon(Icons.email, color: _primaryColor),
              title: Text('abircherif212@gmail.com',
                  style: GoogleFonts.poppins(
  ...
  Widget _buildDrawerItem(
      IconData icon, String title, double scrollPosition) {
    return ListTile(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              border: Border.all(
                  color: _accentColor.withOpacity(0.5), width: 2),
            ),
          ),
          CircleAvatar(
  ...
  List<Widget> _buildHeroTextContent(bool isMobile) {
    return [
      ...
      FadeInUp(
        ...
        child: Text(
          isFrench
              ? 'Spécialisée en architecture Flutter scalable,\nCI/CD et développement white-label'
              : 'Specialized in scalable Flutter architecture,\nCI/CD automation & white-label development',
          style: GoogleFonts.poppins(
        ...
        child: Wrap(
          ...
          children: stats
              .map((s) => _buildStatItem(s['value'] as String,
                  s['label'] as String, s['icon'] as IconData, isMobile))
              .toList(),
        ),
      ),
    );
    ...
    return FadeInLeft(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            _buildSectionHeader(
                isFrench ? 'À Propos' : 'About Me', Icons.person),
            const SizedBox(height: 20),
            Text(
              isFrench
                  ? 'Ingénieure Mobile spécialisée dans le développement d\'applications Flutter en production. Experte en architecture scalable (Clean Architecture, MVVM) et conception de SDK modulaire, livrant des applications cross-platform haute performance avec ownership complète du cycle de mise en production sur Google Play et l\'App Store. Solide expertise en automatisation CI/CD, fonctionnalités temps réel et développement white-label en environnement Agile/Scrum.'
                  : 'Mobile Software Engineer specialized in building and maintaining high-quality, complex cross-platform applications using Flutter and Dart. Experienced in scalable architecture (Clean Architecture, MVVM) and modular SDK design, delivering high-performance apps with full release lifecycle ownership across Google Play and App Store. Strong background in CI/CD automation, real-time features, and white-label development within Agile/Scrum environments.',
              style: GoogleFonts.poppins(
                  fontSize: 15, color: _subtextColor, height: 1.7),
            ),
            const SizedBox(height: 20),
            Wrap(
              spacing: 10,
              ...
              children: [
                ...
                _buildHighlightChip('GoRouter · Deep Linking'),
    ...
    final specialties = [
      {
        ...
        'desc': isFrench
            ...
            : 'High-performance cross-platform apps for Android & iOS with scalable architecture',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(desc,
              style: GoogleFonts.poppins(
                  fontSize: 12.5, color: _subtextColor, height: 1.5)),
        ],
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTimelineCard(
              ...
              points: [
                isFrench
                    ? 'Conçu une app travel white-label avec écosystème SDK modulaire de 6+ packages Flutter réutilisables, réduisant le temps de développement de 40%'
                    : 'Architected a white-label travel app with modular SDK ecosystem of 6+ reusable Flutter packages, reducing development time by 40%',
                isFrench
                    ? 'Mis en place des pipelines CI/CD end-to-end (GitLab, Fastlane) avec builds multi-flavor et Clean Architecture & MVVM, atteignant 80% de couverture de tests'
                    : 'Designed end-to-end CI/CD pipelines (GitLab, Fastlane) with multi-flavor builds and Clean Architecture & MVVM, achieving 80% test coverage',
                isFrench
                    ? 'Implémenté des fonctionnalités temps réel : achats in-app sécurisés, paiements via REST APIs et WebSockets, avec Riverpod, GoRouter et Dio/Retrofit'
                    : 'Implemented real-time features: secure in-app purchases, payment integration via REST APIs & WebSockets, using Riverpod, GoRouter and Dio/Retrofit',
                isFrench
                    ? 'Géré le cycle de release complet : soumission stores, signing, conformité et documentation technique'
                    : 'Owned full release lifecycle: store submission, signing, compliance, and technical documentation',
              ],
              technologies: [
                'Flutter',
                'Riverpod',
            ...
            _buildTimelineCard(
              ...
              company: 'Continuous Net',
              duration:
                  isFrench ? 'Fév 2023 – Juil 2023' : 'Feb 2023 – Jul 2023',
              isCurrent: false,
              points: [
                isFrench
            ...
            _buildTimelineCard(
              ...
              company: isFrench
                  ...
                  : 'DRÄXLMAIER Group',
              duration:
                  isFrench ? 'Juin 2022 – Aout 2022' : 'Jun 2022 – Aug 2022',
              isCurrent: false,
              points: [
                isFrench
                ...
                Wrap(
                  ...
                  children: [
                    if (playStoreUrl != null)
                      _buildStoreButton(Icons.android, 'Play Store',
                          playStoreUrl, Colors.green.shade600),
                    if (appStoreUrl != null)
                      _buildStoreButton(Icons.phone_iphone, 'App Store',
                          appStoreUrl, Colors.blueGrey.shade700),
                    if (websiteUrl != null)
                      _buildStoreButton(
  ...
  List<Widget> _projectCardContent({
    ...
    return [
      ...
      Text(description,
          style: GoogleFonts.poppins(
              fontSize: 14, color: _subtextColor, height: 1.6)),
      if (technologies.isNotEmpty) ...[
        const SizedBox(height: 14),
        Wrap(
          spacing: 8,
            ...
            LayoutBuilder(builder: (context, constraints) {
              ...
              return isWide
                  ? Row(
                      ...
                      children: [
                        Expanded(
                            child: Column(children: col1)),
                        const SizedBox(width: 16),
                        Expanded(
                            child: Column(children: col2)),
                        const SizedBox(width: 16),
                        Expanded(
                            child: Column(children: col3)),
                      ],
                    )
                  : Column(
                      children: [
  ...
  Widget _buildSkillCategoryCard(String category, IconData icon,
      List<String> skills, Color color) {
    return Container(
  ...
  Widget _buildContactCard(IconData icon, String platform,
  ...
  Widget _buildFooter() {
    return Container(
      ...
      child: Column(
        children: [
          Text(
            '© 2026 Abir Cherif · Flutter Mobile Developer',
            style: GoogleFonts.poppins(
